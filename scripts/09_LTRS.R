...
project_dir <- "/data/users/kweisensee/assembly"

#-------------------------------------------------
# Input files (edit paths if needed)
#-------------------------------------------------
gff_file <- paste0(project_dir,"output/EDTA/No-0.fa.mod.EDTA.raw/No-0.fa.mod.LTR.intact.raw.gff3")
cls_file <- paste0(project_dir,"output/TE_Sorter/No-0.fa.mod.LTR.raw.fa.rexdb-plant.cls.tsv")
