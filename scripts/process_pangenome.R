...
# 0) Inputs
# -----------------
wd <- "/data/users/kweisensee/assembly/output/Genespace" # set your working directory where the pangenome_matrix.rds is located
focal_genome <- "No_0" # Your focal accession name
